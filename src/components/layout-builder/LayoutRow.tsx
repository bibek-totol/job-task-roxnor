...
export const LayoutRow = ({ row, rowIndex, setCanvas, moveRow, moveColumn, moveComponent, resizeColumn, handleItemClick }) => {
  ...
  return (
    <div
      ref={ref}
      onClick={(e) => handleItemClick(e, rowIndex,"Row ID: ")}
